...
- [ ] 4.1 (Usuário) Depois do teste no iPhone registrado (T-01 5.4 e T-04 a T-08): abrir o PR `dev` → `main` no GitHub e mesclar (design D2); verificar que o deploy de produção da `main` fica **Ready** na Vercel
